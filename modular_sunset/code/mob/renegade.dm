...
/mob/living/simple_animal/hostile/renegade/guardian
	...
	casingtype = /obj/item/ammo_casing/shotgun
	loot = list(/obj/effect/spawner/bundle/f13/trenchshotgun, /obj/effect/spawner/lootdrop/f13/weapon/gun/ammo/tier1, /obj/item/stack/f13Cash/random/low, /obj/item/clothing/suit/armor/plates)
	robust_searching = TRUE
